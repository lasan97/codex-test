...
const PostDetail: React.FC = () => {
  ...
  if (!post) {
    return <div className="flex justify-center items-center p-6 text-gray-600">Loading...</div>
  }

  return (
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 mt-6">
      <h2 className="text-4xl font-extrabold mb-6 text-gray-900 tracking-tight">{post.title}</h2>
